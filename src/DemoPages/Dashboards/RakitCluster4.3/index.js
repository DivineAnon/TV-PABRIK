...
export default class RakitCluster43 extends Component {
    constructor() {
        super();
      ...
      async getDataPerfomance(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/ranking-cluster-43';
      ...
      async getDataPoin(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/poin-cluster-43';
      ...
      async getDataPoinRakit(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-rakit-cluster-43';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPolesRangka(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-poles-rangka-cluster-43';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPB(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-pasang-batu-cluster-43';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPolesBRJ(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-poles-brj-cluster-43';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataRakit(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-rakit-cluster-43';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPolesRangka(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-poles-rangka-cluster-43';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPasangBatu(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-pasang-batu-cluster-43';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPolesBRJ(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-poles-brj-cluster-43';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getBRJ(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/brj-cluster-43';
        await axios.get(urlprod)
        .then(res => {
            const brj = res.data;
            let dates = [];
                        ...
                        <div className="card no-shadow bg-transparent no-border rm-borders">
                            <Slider {...settings}> 
                                <div className="slider-item">                      
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'white'}}>BEST PERFOMANCE CLUSTER 4.3</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                ...
                                <div className="slider-item">                                                         
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'white'}}>BRJ Bulanan Cluster 4.3</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
