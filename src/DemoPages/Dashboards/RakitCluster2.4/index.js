...
export default class RakitCluster10 extends Component {
    constructor() {
      ...
      async getDataPerfomance(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/ranking-cluster-24';
      ...
      async getDataPoin(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/poin-cluster-24';
      ...
      async getDataRakit(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-rakit-cluster-24';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPolesRangka(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-poles-rangka-cluster-24';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPasangBatu(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-pasang-batu-cluster-24';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getDataPolesBRJ(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/data-poles-brj-cluster-24';
        const res = await axios.get(urlprod);
        // console.log(res.data);
      ...
      async getBRJ(){
        ...
        const urlprod = 'http://103.247.217.10:8091/api/brj-cluster-24';
        await axios.get(urlprod)
        .then(res => {
            const brj = res.data;
            let dates = [];
                        ...
                        <div className="card no-shadow bg-transparent no-border rm-borders">
                            <Slider {...settings}> 
                                <div className="slider-item">                      
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'black'}}>BEST PERFOMANCE CLUSTER 2.4</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                ...
                                <div className="slider-item">                                                         
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'black'}}>BRJ Bulanan Cluster 2.4</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
