...
export default class RakitCluster22 extends Component {
    constructor() {
        super();
      ...
      async getDataPoinRakit(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-rakit-cluster-22';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPolesRangka(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-poles-rangka-cluster-22';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPB(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-pasang-batu-cluster-22';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
      ...
      async getDataPoinPolesBRJ(){
        // const url = 'http://localhost:8090/api/poin-coba2';
        const urlprod = 'http://103.247.217.10:8091/api/poin-poles-brj-cluster-22';
        await axios.get(urlprod)
        .then(res => {
            const poins = res.data;
            let labels = [];
                        ...
                        <div className="card no-shadow bg-transparent no-border rm-borders">
                            <Slider {...settings}> 
                                <div className="slider-item">                      
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'white'}}>BEST PERFOMANCE CLUSTER 2.2</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                ...
                                <div className="slider-item">                                                         
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
                                            <h1 className="text-center" style={{color:'white'}}>BRJ Bulanan Cluster 2.2</h1>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col lg="12" md="12" sm="12">
